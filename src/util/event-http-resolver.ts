...
export class EventHttpResolver {
    ...
    private readonly eventHttpTargets = new Map<string, string>();
    private readonly eventHttpHeaders = new Map<string, object>();
    ...
    private addHttpEntry(config: ConfigReader, i: number) {
