# Session (2026-09-01T20:28:58.000Z)
...
(renormalize check: staged diff stayed within agent-memory files). Semantic: all 8 Open
...
refresh-metadata cleared the pre-existing stale tiers.
